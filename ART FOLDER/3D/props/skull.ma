...
//Name: skull.ma
//Last modified: Thu, Mar 14, 2019 10:55:08 AM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.6093115388652031 1.2595545614793697 0.60606751297833994 ;
	setAttr ".r" -type "double3" -363.33835263249347 -8171.3999999864227 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "2DB1352F-4A30-546F-1B23-93BDAF3BFB49";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 6.1011561778712267;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F2E34605-48B1-6882-FF7B-8EA9DD006D87";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "66008E06-4CDA-B41A-F922-369E508D2D9A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B4AAF34D-43AA-89C4-377E-4A9D53AE9930";
createNode displayLayerManager -n "layerManager";
	rename -uid "8C04209F-4305-70F1-B6AA-458ABDA7CCBF";
createNode displayLayer -n "defaultLayer";
	rename -uid "94E51171-4A02-26C2-56A3-32921F94E5F0";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "036971B7-489E-5C23-B90F-0F829559AD23";
